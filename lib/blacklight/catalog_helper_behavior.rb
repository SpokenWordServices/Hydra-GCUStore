## This was copied out of the blacklight 3.1 repo.  We need to include the behavior, but it wasn't availble in 3.0
## When hull is upgraded to BL 3.1, we can remove this file.
# -*- encoding : utf-8 -*-
